...
const PASOS = [
  ...
  },
  {
    tab: "security",
    icono: "🔐",
    titulo: "Seguridad & Configuración",
        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              overflow: "hidden",
              boxShadow:
                "0 32px 80px rgba(0,0,0,.65), 0 0 0 1px rgba(0,212,255,.06), inset 0 1px 0 rgba(0,212,255,.08)",
            }}
          >
            {/* Barra de progreso */}
                ...
                >
                  <motion.div
                    ...
                    style={{
                      ...
                      lineHeight: 1,
                      marginBottom: ".9rem",
                      filter: "drop-shadow(0 0 16px rgba(0,212,255,.4))",
                    }}
                  >
                    {PASOS[paso].icono}
                  </motion.div>
